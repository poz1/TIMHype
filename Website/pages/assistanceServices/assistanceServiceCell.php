<div class="devices-device-box realsize"> 
    <div class="devices-device-inside-box realsize">
        ...
        <div class="devices-device-description">
            ...
            <button class="devices-device-more-info-button" onclick="navigateToAssistanceServicesDetailPage(<?php echo $_GET['ID']?><?php echo','.$_GET['Highlights'];?><?php echo','.$_GET['Promotion'];?>)">More info</button>
        </div> 
    </div>
</div>